class AlertsController < ApplicationController
  ...
  def index
    ...
    @items = apply_index_sort(Alert.items_in_namespace(current_user, @current_namespace).not_deleted.includes(:metric))
  end
  ...
  def alert_params
    params.require(:alert).permit(:name, :metric_id, :threshold, :direction, :namespace, :delay, :message, :disabled)
  end
end

...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name survey survey
...
# Service label for Kamal validation (required when using --skip-push)
LABEL service=routine
